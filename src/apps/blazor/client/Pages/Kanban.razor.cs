...
namespace imediatus.Blazor.Client.Pages;
...
public partial class Kanban
{
    ...
    private void ItemUpdated(MudItemDropInfo<PortfolioItem> PortfolioItem)
    {
    ...
    private async Task AddPortfolioAsync(NewPortfolioItem newPortfolioItem)
    {
