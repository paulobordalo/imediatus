...
namespace imediatus.Blazor.Client.Pages.Identity.Users;
...
public partial class Users
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        _canExportUsers = await AuthService.HasPermissionAsync(user, ImediatusActions.Export, ImediatusResources.Users);
        _canViewRoles = await AuthService.HasPermissionAsync(user, ImediatusActions.View, ImediatusResources.UserRoles);
        _canViewAuditTrails = await AuthService.HasPermissionAsync(user, ImediatusActions.View, ImediatusResources.AuditTrails);

        Context = new(
            entityName: "User",
            entityNamePlural: "Users",
            entityResource: ImediatusResources.Users,
