...
public partial class UserRoles
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        _canEditUsers = await AuthService.HasPermissionAsync(state.User, ImediatusActions.Update, ImediatusResources.Users);
        _canSearchRoles = await AuthService.HasPermissionAsync(state.User, ImediatusActions.View, ImediatusResources.UserRoles);
