...
public abstract class EntityTableContext<TEntity, TId, TRequest>
{
    ...
    /// <summary>
    /// The ImediatusResource that is representing this entity. This is used in combination with the xxActions to check for permissions.
    /// </summary>
    public string? EntityResource { get; }

    /// <summary>
    /// The ImediatusAction name of the search permission. This is ImediatusAction.Search by default.
    ...
    /// <summary>
    /// The permission name of the create permission. This is ImediatusAction.Create by default.
    ...
    /// <summary>
    /// The permission name of the update permission. This is ImediatusAction.Update by default.
    ...
    /// <summary>
    /// The permission name of the delete permission. This is ImediatusAction.Delete by default.
    ...
    /// <summary>
    /// The permission name of the export permission. This is ImediatusAction.Export by default.
    /// </summary>
        ...
        Func<TEntity, bool>? canDeleteEntityFunc)
    {
        ...
        SearchAction = searchAction ?? ImediatusActions.Search;
        CreateAction = createAction ?? ImediatusActions.Create;
        UpdateAction = updateAction ?? ImediatusActions.Update;
        DeleteAction = deleteAction ?? ImediatusActions.Delete;
        ExportAction = exportAction ?? ImediatusActions.Export;
