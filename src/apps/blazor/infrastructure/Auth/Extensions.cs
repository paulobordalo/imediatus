...
public static class Extensions
{
    ...
    {
        foreach (var permission in ImediatusPermissions.All.Select(p => p.Name))
        {
            options.AddPolicy(permission, policy => policy.RequireClaim(ImediatusClaims.Permission, permission));
        }
    }
}
