...
using imediatus.Blazor.Infrastructure.Storage;
using imediatus.Shared.Authorization;
using Microsoft.AspNetCore.Components;
using Microsoft.AspNetCore.Components.Authorization;
using Microsoft.AspNetCore.Components.WebAssembly.Authentication;

namespace imediatus.Blazor.Infrastructure.Auth.Jwt;
...
public sealed class JwtAuthenticationService : AuthenticationStateProvider, IAuthenticationService, IAccessTokenProvider
{
    ...
    public override async Task<AuthenticationState> GetAuthenticationStateAsync()
    {
        ...
        {
            claimsIdentity.AddClaims(cachedPermissions.Select(p => new Claim(ImediatusClaims.Permission, p)));
        }
