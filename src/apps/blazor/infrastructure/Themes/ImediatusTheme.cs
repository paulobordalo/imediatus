...
namespace imediatus.Blazor.Infrastructure.Themes;

public class ImediatusTheme : MudTheme
{
    public ImediatusTheme()
    {
        ...
        Typography = CustomTypography.ImediatusTypography;
        Shadows = new Shadow();
