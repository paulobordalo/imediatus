        ...
        var item = await cache.GetOrSetAsync(
            ...
            async () =>
            {
                ...
                return entity == null
                    ...
                    : new PortfolioResponse(entity.Id, entity.Summary, entity.SecondaryKey, entity.StatusId, entity.ClassificationId, entity.PriorityId, entity.AssigneeId, entity.ReporterId);
            },
