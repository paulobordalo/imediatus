...
namespace imediatus.WebApi.Catalog.Domain.Models;
...
public class Portfolio : AuditableEntity, IAggregateRoot
{
    ...
    private Portfolio(Guid id, string? summary, int statusId, int classificationId, int priorityId, Guid? assigneeId, Guid reporterId)
    {
        Id = id;
        Summary = summary;
        StatusId = statusId;
    ...
    public static Portfolio Create(string? summary, int statusId, int classificationId, int priorityId, Guid? assigneeId, Guid reporterId)
    {
        return new Portfolio(Guid.NewGuid(), summary, statusId, classificationId, priorityId, assigneeId, reporterId);
    }

    public Portfolio Update(string? summary, int? statusId, int? classificationId, int? priorityId, Guid? assigneeId, Guid? reporterId)
    {
